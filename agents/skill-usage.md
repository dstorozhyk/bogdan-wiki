...
Curator is enabled: 7 runs; last run about 1 day before this snapshot; 7-day interval; stale threshold 30 days; archive threshold 90 days; LLM consolidation is off. Least-recently-active examples: `google-ai-tools` (29 days), `online-shopping-research` (26 days), `xurl` (24 days), then never-active skills.

## Review Recommendations — 2026-07-16
