...
| Agent-created skills | 75 active; 2 stale; 0 archived (77 total) |
...
Curator is enabled: 8 runs; its latest run was 3 days ago; 7-day interval; stale threshold 30 days; archive threshold 90 days; LLM consolidation is off. It reports two stale agent-created skills and no archives. The status command did not name them; use the curator report or sidecar before acting.

## Review Recommendations — 2026-07-25
