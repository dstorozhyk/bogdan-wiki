...
| Agent-created skills | 77 active; 2 stale; 0 archived (79 total) |
...
Curator is enabled: 8 runs; its latest run was 4 days ago; 7-day interval; stale threshold 30 days; archive threshold 90 days; LLM consolidation is off. It reports two stale agent-created skills and no archives. The status command did not name them; inspect its report or sidecar before any lifecycle decision.

## Review Recommendations — 2026-07-26

- Human-review the two curator-stale skills; retain, repair, pin, consolidate later, or archive only through an explicit decision.
