...
- [ ] **2026-07-20 — Restore memory tool, then apply staged non-secret compaction**
  ...
  - Risk/staleness: retain identity, stable preferences, active roots, and essential non-secret configuration pointers; do not mirror credentials or keys in wiki.
  - Evidence: 2026-07-20 nightly consolidation; one batched operation per target returned `Memory is not available`.
...
- [ ] **2026-07-18 — Apply safe non-secret memory compaction after memory-tool repair**
  ...
  - Evidence: 2026-07-18 nightly consolidation; one batched operation per target returned `Memory is not available`.
...
- [ ] **2026-07-20 — Human review of critical-skill pinning from repeated telemetry**
  - Proposed action: decide whether high-impact skills such as `obsidian`, `claude-code`, `youtube-content`, `gemini-and-notebooklm`, and Hermes operational runbooks should be pinned.
  - Evidence: nightly telemetry 2026-07-07–2026-07-20; 113 tracked skills, `obsidian` activity 56, and curator reports 80 agent-created skills active with none stale/archived.
  - Boundary: pinning is a human lifecycle decision; nightly consolidation must not pin, archive, delete, install, or consolidate automatically.

- [ ] **2026-07-18 — Human review of critical-skill pinning from repeated telemetry**
  ...
  - Evidence: nightly telemetry from 2026-07-07 through 2026-07-18; 113 tracked skills, `obsidian` activity 54, and curator reports 80 agent-created skills active with none stale/archived.
  - Boundary: pinning is a human lifecycle decision; nightly consolidation must not pin, archive, delete, install, or consolidate automatically.
