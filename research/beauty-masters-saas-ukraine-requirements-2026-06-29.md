...
## Public profile / сайт-візитівка — standalone-first

Окреме продуктове правило: **public-візитівка має працювати і з CRM, і без CRM**.

Базовий сценарій не повинен вимагати календаря, CRM, онлайн-запису чи автоматизації. Якщо майстер ще не довіряє автоматизації або хоче просто красиве посилання в Instagram/Telegram, сторінка все одно має давати цінність.

### Baseline без CRM

Public page завжди має підтримувати:

- образ майстра: імʼя, напрям, місто/район, короткий tagline;
- послуги і ціни як просте beauty-меню;
- портфоліо / фото робіт;
- Instagram / соцмережі;
- маршрут / адреса;
- швидкий контакт: Telegram, Viber, WhatsApp або телефон;
- CTA типу **“Написати / записатись”**, який може вести просто в чат.

Це валідний сценарій:

> “Клієнт відкрив сторінку, подивився роботи, ціни, адресу і написав майстру.”

### Optional modules

CRM/booking-функції мають бути модульними, а не обовʼязковими:

| Модуль | Коли показувати | Якщо модуля нема |
|---|---|---|
| Онлайн-запис | Майстер готовий приймати заявки через форму/календар | CTA веде в чат |
| Вільні слоти | Підключений календар або майстер вручну задає доступні вікна | Секція прихована |
| Нагадування | Майстер увімкнув Telegram/Viber/SMS templates | Не показувати клієнту системні формулювання |
| CRM-картка клієнта | Тільки в кабінеті майстра | Не впливає на public page |
| Аналітика / money hints | Тільки dashboard/admin | Ніколи не показувати на public page |
| QR | Промо-asset для друку/Instagram/дзеркала | Не показувати QR на самій візитівці |

### Design direction

Візитівка має бути не mini-dashboard і не generic landing, а **mobile-first персональна картка майстра**:

1. Hero / обкладинка майстра: фото або mood image, імʼя, спеціалізація, район.
2. Головний CTA: “Написати / записатись”.
3. Послуги і ціни.
4. Портфоліо / останні роботи.
5. Відгук або trust block.
6. Маршрут.
7. Соцмережі / чат.
8. Optional: онлайн-запис, вільні слоти, нагадування — тільки якщо підключені.

Референсний патерн: вертикальна link-in-bio / Royal-like visit card, але адаптована під beauty: більше фото, послуг, довіри і запису.

### Theme rule

Не використовувати темну золото-чорну тему як базову для beauty-візитівки. Краще світлі premium-напрями:

- Editorial Nude — nails/brows/lashes, теплий beauty editorial;
- Champagne Ivory — hair/brows/premium studio, ivory/champagne/cacao без чорного фону;
- Clean Clinic — cosmetology/massage/laser, чистота і довіра;
- Soft Bloom — bridal/makeup/lashes;
- Minimal Luxe — premium salon/studio owner.
